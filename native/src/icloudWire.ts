...
//
// The types below MIRROR `src/app/storage/icloudHost.ts`'s rather than
// importing them: `native/` is a separate npm project and reaching across
// would make the wrapper's typecheck depend on the web app's module
// resolution.
