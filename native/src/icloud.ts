...
//     the app — or its widgets — fails to start.
...
// notes, and the only place they belong is the container and the page that
// asked for them. In particular nothing here feeds the widgets — they read the
// page's own storage through `injected.ts`, whichever backend is active.
