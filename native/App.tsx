...
// and every bar that meets an edge (the top menu, the settings sheet) pads itself with
// `env(safe-area-inset-*)` — which is how the installed PWA looks. Framing the
// WebView inside the safe area instead zeroes those insets and leaves two flat
// bands above and below the page, so the bars stop short of the status bar
