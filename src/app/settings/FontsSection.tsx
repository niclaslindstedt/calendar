...
// The Calendar tab's type: which face each part of a day is set in.
//
...
// itself. How *big* each of them is set is the neighbouring section's
// question (`TextSizeSection`).
//
